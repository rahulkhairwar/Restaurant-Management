...
<link href="changePasswordStyles.css" rel="stylesheet" type="text/css" />
</head>
<body background="changePasswordBackground.jpg">
...
<!-- 	    <form action="placeOrder.php">
		...
		<input type="submit" id="orderHistory" value="Previous Orders">
		</form>
</body>
</html>
