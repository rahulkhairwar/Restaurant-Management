...
<!-- <body background="static/images/fetchDessertsBackground.jpg"> -->
<body>

	<script type="text/javascript">
        changeBackground('desserts');
    </script>
...
$fetchDesserts = "select * from menu where dishType = 'dessert'";
$result = mysqli_query($connection, $fetchDesserts);
